...
register(
    ...
    entry_point='gym.envs.box2d:LunarLanderRandomZone',
    max_episode_steps=1000,
    reward_threshold=200,
)

register(
    id='LunarLanderMoreRandStart-v2',
    entry_point='gym.envs.box2d:LunarLanderMoreRandStart',
    max_episode_steps=1000,
    reward_threshold=200,
)

register(
    id='LunarLanderLimitedFuel-v2',
    entry_point='gym.envs.box2d:LunarLanderLimitedFuel',
    max_episode_steps=1000,
    reward_threshold=200,
)
